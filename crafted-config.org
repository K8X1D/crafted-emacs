:DOC-CONFIG:
#+PROPERTY: header-args :mkdirp yes :comments no :tangle ~/.config/crafted-emacs/config.el
#+STARTUP: fold
:END:
...
#+BEGIN_SRC emacs-lisp :tangle ~/.config/crafted-emacs/custom-modules/k8x1d-org.el 
...
#+BEGIN_SRC emacs-lisp :tangle ~/.config/crafted-emacs/custom-modules/k8x1d-julia.el 
...
#+BEGIN_SRC emacs-lisp :tangle ~/.config/crafted-emacs/custom-modules/k8x1d-R.el 
...
#+html: <details><summary>k8x1d-R.el</summary>
#+BEGIN_SRC emacs-lisp :tangle ~/.config/crafted-emacs/custom-modules/k8x1d-git.el 
